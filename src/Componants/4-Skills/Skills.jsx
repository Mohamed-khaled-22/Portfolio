...
export default function Skills() {
    ...
    // Animation variants للسيكشن كله
    const sectionVariants = {
        hidden: { opacity: 0, y: 50 },
        visible: { opacity: 1, y: 0, transition: { duration: 0.7 } }
    }

    // Animation variants لكل skill
    const skillVariants = {
    ...
    return (
        <motion.div className='skills-section' id='skills' initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.2 }} variants={sectionVariants}>
            ...
            >
                ...
                {/* all this icon from https://devicon.dev/ */}
